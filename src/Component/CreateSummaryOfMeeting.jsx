...
const CreateSummaryOfMeeting = () => {
  // const [handleReset,sethandleReset]= useState(null);
      ...
      <form className='mt-0'>
        ...
        <div className='form-row mr-2' style={{ direction: 'rtl' }}>
          <button
            ...
            // eslint-disable-next-line no-unused-expressions
            // eslint-disable-next-line no-lone-blocks
            onClick={(e) => {delay();validateAndSend(e)}}>
ثبت نهایی          </button >
              
        </div>
        <div className='form-row mr-2' style={{ direction: 'rtl' }}>
     {/* // <Skeleton  duration={2} delay={2} count={5} circle={true} height={50} width={50}/> */}
              <button  variant="danger" onClick={resetInputField}  className='btn btn-danger mt-2 ml-3 w-100'>Reset</button>
        </div>
